...
if [ -d "android-ndk-${v_ndk}" ]; then
	...
	cp -n android-ndk-${v_ndk}/sources/third_party/vulkan/src/include/vulkan/* android-ndk-${v_ndk}/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include/vulkan
